# Antigravity (agy) Prompt Template (Token-Efficient)
...
## Research (use grounding / web search)

```
Task:
- Research <topic/question> and summarize current best practice.

Constraints:
- Cite sources (URLs).
- Keep it concise; flag anything uncertain or fast-moving.

Output:
- Bullet summary + a short sources list.
```
