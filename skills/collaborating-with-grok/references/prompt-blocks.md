...
Use when grok might otherwise guess about repository facts.
...
Use when web/X research or source references matter. grok's live search returns source URLs — make it cite them.

```xml
<citation_rules>
Back important claims with a source URL from your web/X search.
Prefer primary sources. Separate what a source states from what you infer.
</citation_rules>
```
